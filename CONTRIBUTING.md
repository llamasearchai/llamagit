# Contributing to LlamaGit

Thank you for your interest in contributing to LlamaGit! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaGit:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamagit.git
   cd llamagit
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamagit.git
   ```
...
By contributing to LlamaGit, you agree that your contributions will be licensed under the project's MIT License.
